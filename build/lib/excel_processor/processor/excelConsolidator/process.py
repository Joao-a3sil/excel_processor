from processor.utils.util import get_project_path, medir_tempo_execucao
import pandas as pd
...
class ExcelConsolidator:
    ...
    def consolidar(self):
        ...
        print(f"Arquivo '{self.output_file}' criado com sucesso!")
    ...
    def organizar_colunas(self):
        ...
        print(f"Arquivo '{self.data_base_file}' criado com sucesso!")

@medir_tempo_execucao
def gerar_data_base():
       
    output_file = get_project_path("excel_processor", "output", "Consolidado_data_base_C&A_completo.xlsx")
    data_base_file = get_project_path("output", "Consolidado_data_base_C&A.xlsx")
    
    process_cea = ExcelConsolidator(str(output_file), str(data_base_file))
