...
class excel_consolidator:
    ...
    def consolidar(self):
        ...
        input_parcela_self = get_project_path("output", "Parcela_Self_Data_base.xlsx")
        ...
        parcela_self_df = pd.read_excel(input_parcela_self, sheet_name="Parcela Self")
        ...
        with pd.ExcelWriter(self.output_file, engine="openpyxl") as writer:
            ...
            parcela_self_df.to_excel(writer, sheet_name="Parcela Self", index=False)
    ...
    def organizar_colunas(self):
        ...
        parcela_self_df = pd.read_excel(input_file, sheet_name="Parcela Self")
        ...
        colunas_parcela_self = ["loja", "data", "venda", "seguro", "habil"]
        ...
        parcela_self_df = parcela_self_df[colunas_parcela_self]
